...
export default function NextCurve() {
  return (
    <section className="bg-secondary">
      <div className="container flex flex-col gap-8 lg:gap-0 lg:flex-row">
        <article className="lg:w-1/2 *:text-slate-200 overflow-hidden sm:border-b lg:border-b-0 lg:border-r border-slate-400 pb-10">
          <h2 className="h-20 flex justify-center items-center text-center font-poppins-bold my-12 text-4xl lg:text-5xl">
            The next curve
          </h2>
        ...
        <article className="lg:w-1/2 *:text-slate-200 overflow-hidden pb-10">
          <h2 className="h-20 text-center font-poppins-bold my-12 text-4xl lg:text-5xl lg:w-2/3 lg:mx-auto">
            Grow with confidence
          </h2>
          <p className="font-poppins-regular text-center mb-2 px-3 lg:h-19 lg:py-3">
            From entry-level to C-suite, from a single hire to fully
            outsourcing, let our specialized recruiters find the individuals
            with the skills you need - the best fit for your organization
          </p>
          <Link
