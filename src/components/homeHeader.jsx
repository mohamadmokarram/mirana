  ...
  return (
    <header className="grow flex flex-col lg:flex-row mt-4">
      <section className="lg:w-1/2 flex flex-col p-4">
        ...
        <p className="text-center md:text-left mt-10 font-poppins-regular px-3">
        ...
        <div className="flex flex-col gap-5 md:gap-2 md:flex-row mt-10">
      ...
      <section className="lg:w-1/2">
        <img className="w-full h-full object-cover" src={headerImg} alt="job" />
      </section>
    </header>
  );
}
